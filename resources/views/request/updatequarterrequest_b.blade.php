        ...
        <div class="row">
          ...
          <div class="col-md-7">
            ...
            <tr>
                ...
                <th>નામ(પુરેપુરૂ)</th>
                <td colspan="4">
                    {{ isset($quarterrequest['name']) ? $quarterrequest['name'] : 'N/A' }}
                </td>
            </tr>
            <tr>
                <th></th>
            ...
            <tr>
                ...
                <td colspan="4">{{ isset($quarterrequest['address']) ? $quarterrequest['address'] : 'N/A' }}</td>
            </tr>
            <tr>
                <th></th>
                <th>( ઇ) જન્મ તારીખ</th>
                <td colspan="4">{{ isset($quarterrequest['date_of_birth']) ? date('d-m-Y', strtotime($quarterrequest['date_of_birth'])) : 'N/A' }}</td>
            </tr>

            <tr>
                <th></th>
                <th>( ઈ ) નિવ્રૂત્તિ ની તારીખ</th>
                <td colspan="4">{{ isset($quarterrequest['date_of_retirement']) ? date('d-m-Y', strtotime($quarterrequest['date_of_retirement'])) : 'N/A' }}</td>
            </tr>
            <tr>
                <th></th>
            ...
            <tr>
                ...
                <td colspan="4">
                    {{ isset($quarterrequest['appointment_date']) ? date('d-m-Y', strtotime($quarterrequest['appointment_date'])) : 'N/A' }}
                </td>
            </tr>
            <tr>
                <th>4</th>
            ...
            <tr>
                ...
                <td colspan="4">
                    {{ isset($quarterrequest['actual_salary']) ? $quarterrequest['actual_salary'] : 'N/A' }}
                </td>
            </tr>
            <tr>
                <th></th>
                <th>( ૧ ) મૂળ પગાર</th>
                <td colspan="4">{{ isset($quarterrequest['basic_pay']) ? $quarterrequest['basic_pay'] : 'N/A' }}</td>
            </tr>
            <tr>
                <th></th>
                <th>( ૨ ) પર્સનલ પગાર</th>
            ...
            <tr>
                ...
                <td colspan="4">
                    {{ isset($quarterrequest['deputation_allowance']) ? $quarterrequest['deputation_allowance'] : 'N/A' }}
                </td>
            </tr>
            <tr>
                <th></th>
            ...
            <tr>
                ...
                <td> {{ isset($quarterrequest['prv_area_name']) ? $quarterrequest['prv_area_name'] : "N/A" }}</td>
            ...
            <tr>
                ...
                <td> {{ isset($quarterrequest['prv_quarter_type']) ? $quarterrequest['prv_quarter_type'] : 'N/A' }}</td>
                <td><strong>(ક-૨) માસીક ભાડું</strong></td>
                <td> {{ isset($quarterrequest['prv_rent']) ? $quarterrequest['prv_rent'] : 'N/A' }}</td>
            </tr>
            <tr>
                <th></th>
                <th></th>
                <td><strong>( ડ ) મકાન મળતાં ઉપર દર્શાવેલ મકાન સરકારને તુરત પાછું આપવામાં આવશે કે કેમ્?</strong></td>
                <td colspan="3">{{ isset($quarterrequest['prv_handover']) ? $quarterrequest['prv_handover'] : 'N/A' }}</td>
            </tr>
            <tr>
                <th>7</th>
                <th>અગાઉ ગાંધીનગર માં મકાન મેળવવા અરજી કરવા માં આવી છે અથવા મકાન ફાળવેલ છે?</th>
                <td> {{ isset($quarterrequest['have_old_quarter']) ? $quarterrequest['have_old_quarter'] : 'N/A' }}</td>
                <td><strong>તારીખ, નંબર, બ્લોક વિગેરે વિગત </strong></td>
                <td colspan="2"> {{ isset($quarterrequest['old_quarter_details']) ? $quarterrequest['old_quarter_details'] : 'N/A' }}</td>
            </tr>
            <tr>
                <th>8</th>
