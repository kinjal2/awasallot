...
<div class="content">
   ...
   <div class="col-md-12">
      ...
      <div class="card card-head">
         ...
         <!-- /.card-header -->
         <!-- form start -->
         <form method="POST" action="{{ route('updateolduserprofiledetails') }}" enctype="multipart/form-data" name='frm' id="frm">
            @csrf
            <div class="card-body">
               <div class="row">
                  <div class="col-md-3">
                  ...
                  <div class="col-md-3">
                     <div class="form-group">
                        ...
                        <div class="input-group date dateformat" id="date_of_birth" data-target-input="nearest">
                           <input type="text" value="{{isset($users->date_of_birth)?date('d-m-Y',strtotime($users->date_of_birth)):''}}" name="date_of_birth" class="form-control datetimepicker-input " data-target="#date_of_birth"  />
