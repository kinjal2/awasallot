                            ...
                            <div class="row p-3">
                                <div class="col-md-4">
                                    <!-- <div class="form-group">
                                     ...
                                     <div class="form-group">
                                                <label for="quarter_type">વસવાટ નો પ્રકાર</label> <span class="error">*</span>
                                                <x-select
                                                    name="quarter_type"
                                                    :options="[null => __('common.select')] + getQuarterType()"
...
$(document).ready(function () {
    ...
    $('#quarter_type').on('change', function () {
        ...
        let quartertype = $(this).val();

        $('#cur_areacode').html('<option value="">Loading...</option>');

        $.ajax({
            url: "{{ route('changerequest.getArea') }}",
            type: 'POST',
            data: { quartertype: quartertype },
             headers: {
