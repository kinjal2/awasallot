                  ...
                  <div class="row">
                     ...
                     <div class="col-md-3" id='dis_per_yes' style="display:none">
                        <div class="form-group">
                           ...
                           <input type="text" class="form-control" value="{{isset($users->dis_per)?$users->dis_per:''}}" id="dis_per" placeholder="Enter..." name="dis_per">
                           @if($users->dis_per >= 60 && $attacheddocument != null)
                           <a href="javascript:;" target="_blank" class="btn btn open-document-btn"
                              data-id="{{ $attacheddocument->doc_id }}">
                              <img src="{{ asset('/images/pdf.png') }}" width="30" height="30">{{ $attacheddocument->document_name }}
                           </a>
                           @endif
                        </div>
                     </div>
