        ...
        <div class="container">
          ...
          <div class="row content" data-aos="fade-up">
            ...
            <div class="col-lg-6 pt-4 pt-lg-0">
              <img class="img-responsive" src="{{ URL::asset('/images/gift-home.jpg') }}" alt="Home" title="Home">
            </div>
          </div>
        </div>
      </section>
            ...
            <div class="col-lg-7 mt-5 mt-lg-0" data-aos="fade-right">
              <div id="letest-news">
                <ul class="list">
                  <li>
                    <span class="title">
                      <h4><a href="{{ url(config('app.asset_url'),'/').'/downloads/UserRegistration.pdf' }}" target="_blank" class="blink_text" target="_blank">User Registration</a></h4>
                    </span>
                  </li>
                  <li>
                    <span class="title">
                      <h4><a href="{{ url(config('app.asset_url'),'/').'/downloads/Userlogin.pdf' }}" target="_blank" class="blink_text" target="_blank">User Guidelines</a></h4>
                    </span>
                  </li>
                  <li>
                    <span class="title">
                      <h4><a href="{{ url(config('app.asset_url'),'/').'/downloads/DDOLogin.pdf' }}" target="_blank" class="blink_text" target="_blank">DDO Guidelines</a></h4>
                    </span>
                  </li>
                  <li>
                    <span class="title">
                      <h4><a href="{{ url(config('app.asset_url'),'/').'/downloads/ddo.pdf' }}" target="_blank" class="blink_text" target="_blank">View DDO Registration Number</a></h4>
                    </span>
                  </li>
                  <li>
                    <span class="title blink_text">
                      <h4>For Queries like Changes in Application Form, Incorrect Data Selection or DDO Details Update or Password Update,<br> send mail to :- <span style="color:blue;">awasallot-secpc-gnr@gujarat.gov.in</span> </h4> <br> Please do not send mail to : itcell.rnb2018@gmail.com
                    </span>
                  </li>
                  <li>
                  ...
                  <table class=" table table-bordered table-striped table-responsive-stack text-center">
                    <thead class="cf">
                      <tr>
                        <th>અનુ.</th>
                        <th>વસવાટની કક્ષા</th>
                        <th class="numeric">સાતમા પગારપંચ મુજબ મુળ પગાર (રૂપિયા)</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr>
                      ...
                      <tr>
                        <td>૧૩</td>
                        <td>મંત્રીશ્રીઓના બંગલા</td>
                        <td>પગારધોરણ ધ્યાને લીધા સિવાય</td>
                      </tr>
                    </tbody>
                  </table>
