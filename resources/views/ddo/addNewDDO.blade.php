                        ...
                        <div class="form-group">
                            ...
                            <select name="district" id="district" class="form-control select2">
                                ...
                                @foreach(getDistricts() as $key => $district)
                                    <option value="{{ $key }}" data-name="{{ $district }}"
...
$(document).ready(function() {
    ...
    $("#ddoForm").validate({
        rules: {
            ...
            ddoofficename: { required: true, lettersonly: true },
            districtname: { required: true, lettersonly: true },
            cardex_no: { required: true, digits: true },
            ddo_registration_no: {
                required: true,
                ddoPattern: true,
                minlength: 10,
