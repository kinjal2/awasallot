                ...
                <div class="table-responsive p-4">
                    <form id="ddoForm" name="ddoForm" class="form-horizontal" action="{{ route('ddo.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <input type="text" class="form-control" id="ddo_registration_no" name="ddo_registration_no" placeholder="Enter DDO Registration No" value="{{ old('ddo_registration_no') }}" minlength="10" maxlength="10">
