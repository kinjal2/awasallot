                    ...
                    <div class="card card-success">
                        ...
                        <div class="card-body">
                            <form method="POST" name="front_annexurea" id="front_annexurea"
                                action="{{ url('submitdocument_a') }}" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group">
                                        ...
                                        <div class="col-12 yesno_status" style="display:none">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="ddo_remarks" id="ddo_remarks">
                                        ...
                                        <div class="card-footer">
                                            ...
                                            <button type="submit" class="btn btn-primary" id="submit_doc"
                                                name="submit_doc">Submit Documents</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
            ...
            @push('footer-script')
                ...
                <script>
                    ...
                    $('#submit_doc').on('click', function(event) {
                        ...
                        //         formData.append('reqid', $('#reqid').val());
                        //         // formData.append('image', file);
                        //         // formData.append('request_id', $('#request_id').val());
                        //         // formData.append('uid', $('#uid').val());
                        //         formData.append('_token', '{{ csrf_token() }}'); // Include CSRF token
                        //         alert(formData.reqid);
                        $.ajax({
                            url: "{{ route('ddo.editquarter.a.submitdocument') }}", // Update with your route name
                            type: 'POST',
                            data: {
                                reqid: $('#reqid').val(),
                                rvid: $('#rvid').val(),
                            ...
                            success: function(response) {
                                ...
                                //$('#message-container_submitdoc').addClass('alert alert-success').text('Documents are submitted successfully!');
                                $('#message-container_submitdoc').addClass('alert alert-success').text(response
                                    .message);
                            ...
                            error: function(xhr) {
                                ...
                                if (xhr.status === 422) {
                                    ...
                                    $('#message-container_submitdoc').addClass('alert alert-danger').text(
