      ...
      <div class="container-fluid">
        ...
        <div class="col-md-12">
           ...
           <!--   <div class="card-header">
              ...
              <!-- /.card-header -->
              <div class="card-body">
              <a class="btn btn-success mb-3" href="javascript:void(0)" id="createNewArea"> Create New Area</a>
            ...
            <div class="modal-body">
                <form id="areaForm" name="areaForm" class="form-horizontal">
                   <input type="hidden" name="area_id" id="area_id">
                    ...
                    <div class="form-group">
                        <label for="name" class="col-sm-6 control-label">Address Gujarati</label>
                        <div class="col-sm-12">
                            <input type="text" class="form-control" id="address_g" name="address_g" placeholder="Enter Address Gujarati" value="" maxlength="50" required="">
                        </div>
                    </div>
