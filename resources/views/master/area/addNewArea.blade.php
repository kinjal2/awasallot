            ...
            <div class="card-body">
                ...
                <form id="areaForm" name="areaForm" class="form-horizontal" action="{{ route('masterarea.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control" id="areaname" name="areaname" placeholder="Enter Area Name" value="{{ old('areaname') }}" maxlength="255">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control" id="address" name="address" placeholder="Enter Address" value="{{ old('address') }}" maxlength="255">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control" id="address_g" name="address_g" placeholder="Enter Address Gujarati" value="{{ old('address_g') }}" maxlength="255">
