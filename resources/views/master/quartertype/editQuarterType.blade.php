            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Edit Quarter Type</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="col-md-12">
        <div class="card card-head">
            <div class="card-header">
                <h3 class="card-title">Edit Quarter Type</h3>
            </div>
            ...
            <div class="card-body">
                ...
                <form id="quartertypeForm" name="quartertypeForm" class="form-horizontal" action="{{ route('masterquartertype.store') }}" method="POST">
                    @csrf

                    <label for="quartertype" class="col-sm-6 control-label">Quarter Type</label>
                    <div class="col-sm-12">
                        <div class="form-group">
                            <input type="hidden" name="officecode" id="officecode" value="{{ base64_encode($quartertype->officecode) }}" />
                            <input type="hidden" name="quartertypeh" id="quartertypeh" value="{{ base64_encode($quartertype->quartertype) }}" />
                            <input type="text" class="form-control" id="quartertype"  name="quartertype" placeholder="Enter Quarter Type" value="{{ $quartertype->quartertype }}" maxlength="255" readonly>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control" id="quartertype_g" name="quartertype_g" placeholder=" Enter Quarter Type Gujarati" value="{{ $quartertype->quartertype_g }}" maxlength="255">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control" id="bpay_from" name="bpay_from" placeholder="Enter Basic Pay From" value="{{ $quartertype->bpay_from }}" maxlength="255">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control" id="bpay_to" name="bpay_to" placeholder="Enter Basic Pay From" value="{{ $quartertype->bpay_to }}" maxlength="255">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control" id="rent_normal" name="rent_normal" placeholder="Enter Basic Pay From" value="{{ $quartertype->rent_normal }}" maxlength="255">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control" id="rent_standard" name="rent_standard" placeholder="Enter Standard Rent" value="{{ $quartertype->rent_standard }}" maxlength="255">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control" id="rent_economical" name="rent_economical" placeholder="Enter Economical Rent" value="{{ $quartertype->rent_economical }}" maxlength="255">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="text" class="form-control" id="rent_market" name="rent_market" placeholder="Enter Market Rent" value="{{ $quartertype->rent_market }}" maxlength="255">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <textarea class="form-control" id="remarks" name="remarks" placeholder="Enter Remarks" maxlength="255">{{ $quartertype->remarks }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                            <input type="number" class="form-control" id="priority" name="priority" placeholder="Enter Priority" value="{{ $quartertype->priority }}" min="1" max="100">
