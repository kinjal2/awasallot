  ...
  <div class="l-form-container mb-4 d-flex justify-content-center p-4">
    ...
    <form method="POST" action="{{ route('phoneverification.verify') }}">
      ...
      <div class="form-group col-sm-12 col-lg-12 ">
        <label class=" mb-2" for=""><span>Mobile Number OTP</span><span class="text-danger text-sm m-1">*</span></label>
        <input type="password" class="form-control" name="otpnumber" id="otpnumber" placeholder='****'>
      </div> <!-- form-group / col ends -->
      <div class="form-group col-sm-12 col-lg-12 ">
        <label class="form-check-label" for="">Email Verification link is sent to your registred Email
...
@endif
  ...
  <div class="row no-gutters">
    <div class="col-12 text-center text-sm mb-3">
      ...
      <div class="d-inline-block"><a href="{{ route('phoneverification.notice') }}">Resend</a></div>
    </div> <!-- col ends -->
  </div> <!-- row ends -->
