...
class DdoUserLoginController extends Controller
{
    ...
    public function login(Request $request)
    {
        ...
        // Store the role and ddo_reg_no in the session
            ...
            session(['ddo_reg_no' => $user->ddo_reg_no]); // Store the ddo_reg_no
            session(['cardex_no' => $user->cardex_no]); // Store the cardex_no
            session(['ddo_code' => $user->ddo_code]); // Store the ddo_code
